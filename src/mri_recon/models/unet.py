...
class UNet(nn.Module):
    """Small U-Net baseline for single-coil MRI reconstruction."""
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        # Residual learning: predict a correction added to zero-filled input.
        return torch.clamp(x + output, min=0.0, max=1.0)
